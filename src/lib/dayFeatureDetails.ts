...
export const featureDetails: FeatureDetail[] = [
  // フロア業務 ── 7 機能
  {
    ...
    bullets: [
      ...
      'タブレット起動から数秒で、その日のフロア全体が見える',
    ],
    image: { alt: 'ダッシュボード画面：本日の業務状況をタブレットで表示' },
  },
  {
    id: 'user-management',
    category: 'floor',
  ...
  },
  {
    ...
    category: 'transport',
    categoryLabel: '送迎業務',
    positioning: 'ドライバー専用の、モバイル UI',
    title: 'ドライバー画面',
    bullets: [
      'スマートフォン 1 台で、その便の乗車順とご自宅地図を確認',
      '乗車完了・出発のボタンで、リアルタイムにフロアへ通知',
      'ご家族からの連絡も、アプリ内で受信可能',
    ],
    image: { alt: 'ドライバー画面：スマホで送迎業務を支援' },
  },
  {
  ...
  },
  {
    ...
    category: 'backoffice',
    categoryLabel: '管理者業務',
    positioning: 'スタッフ・ご利用者の予定を、一画面で',
    title: 'スケジュール管理',
    bullets: [
      'スタッフのシフトとご利用者の利用予定を、同じカレンダーで管理',
      '個別機能訓練の予約も、空き枠から直接登録',
      'タブレット・PC・スマホで同期表示',
    ],
...
export const featureCategories: {
...
}[] = [
  {
    ...
    lead: 'ご利用者の受け入れから記録・申し送りまで。日々の現場業務を、タブレット1枚で支える 7 機能。',
  },
  {
    id: 'transport',
    label: '送迎業務',
