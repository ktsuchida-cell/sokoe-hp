            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-10 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-stone text-sm mb-6 leading-[1.85]">
                  株式会社sokoe 代表取締役 / レッツ倶楽部川西能勢口 施設長代理 / 株式会社ピースファーマシー 在籍
                </p>

                <p className="text-charcoal text-[15px] md:text-base leading-[1.95] mb-6">
                  薬学部卒業後、株式会社ピースファーマシーで薬局運営に携わり、同社運営の1日型デイサービス施設長代理を経て、株式会社sokoe を創業。
                  「介護施設を運営する会社が、ソフトウェアと AI を作る」をコンセプトに、
